...
This project is a bookmark application. It would be a full application
code entirely on Eliom-OCaml platform. 

It would be utilising database binding via Macaque on the Ocsigen 
project. Database would be powered by PostgreSQL.

CSS will be utilising Bootstrap but this would be shelved till the 
later stage of the project. A module would be code to leverage the 
CSS as a module.
